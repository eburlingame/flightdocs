...
airworthiness certificate and a [type certificate data sheet](/docs/topics/airworthiness/documents/tcds).
...
[required inspections](/docs/topics/airworthiness/inspections/AV1ATE).

## Required Documents

An aircraft must have onboard the required
[A.R.R.O.W.](/docs/topics/airworthiness/documents) documents.

## Inoperative Equipment

An aircraft can be flow with
[inoperative equipment](/docs/topics/airworthiness/equipment/inoperative) in some
circumstances as specified by [91.213](/_references/14-CFR/91.213).
