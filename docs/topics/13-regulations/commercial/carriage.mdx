...
import EncodedDataExplainer, {EncodedDataWord } from '@site/src/components/EncodedDataExplainer'
...
> As a commercial pilot, you can offer your pilot services to anyone and be
> compensated for it, so long as you are not the airplane's operator.

A common carrier is a person OR organization that will **"hold itself out"** to
the public, or to a segment of the public.
