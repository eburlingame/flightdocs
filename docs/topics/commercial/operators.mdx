...
[Part 119](https://ecfr.federalregister.gov/current/title-14/chapter-I/subchapter-G/part-119/subpart-A/section-119.1)
requires that an air carrier or commercial operator obtain a operator
certificate.

Any operations of a [common carrier](/docs/topics/commercial/carriage) requires an
