...
- **V<sub>A</sub>**: Design maneuvering speed
  - The maximum speed where the structural design limit can be imposed (via full
    control deflection or gusts) without causing structural damage
...
![Airspeed Indicator Markings](/img/content/airspeed-markings.png)
