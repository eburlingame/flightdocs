...
-   Increase induced drag needed for level flight, and decrease cruise
    performance
    -   This is due to the increase of the tail downforce, which in turn
        requires a high angle of attack to counteract
