...
-   Oscillation errors: Erratic movement of the card caused my turbulence or
    rough control inputs
-   Deviation errors: Errors caused by the magnetics fields produced by
...
-   Dip errors
    -   Acceleration errors: On east or west heading, the compass will show a
        ...
        -   **D**ecelerate
        -   **S**outh
    -   Northerly turning errors: On north or south headings, the compass will
        lead in the north half of the turn, and lag in the south half of the
        turn.
        -   **U**ndershoot
        -   **N**orth
        -   **O**vershoot
