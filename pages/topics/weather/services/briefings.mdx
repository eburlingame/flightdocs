...
Official weather briefings can be obtained though 1-800-WX-BRIEF, or though [1800wxbrief.com](https://www.1800wxbrief.com/Website/#!/).

## Types of Briefings

- Standard briefing
  - Request anytime you are planning a flight for less than 6 hours in the future
- Abbreviate briefing
...
AIM 7-1-3 discusses weather that comes from third party vendors, not official Flight Service or NWS systems:
